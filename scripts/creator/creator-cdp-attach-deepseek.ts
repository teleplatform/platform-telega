...
async function main() {
  ...
  if (!page) {
    console.log("No DeepSeek page found. Opening chat.deepseek.com...");
  ...
  if (loginRequired) {
    console.error("\n❌ DeepSeek login required in Chrome session");
  ...
  console.log(`   Provider: deepseek_web`);
