import type { SurfaceAdaptationInput, SurfaceAdaptationOutput } from "./types.js";
...
const ADAPTER_MAP: Record<string, (text: string) => string> = {
  web: adaptForWeb,
...
export function runSurfaceAdaptation(
  input: SurfaceAdaptationInput,
): SurfaceAdaptationOutput {
