...
export const TELEGPT_COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    ...
    args: "",
    description: { ru: "статус восстановления", en: "recovery status" },
    usage_ru: "/recovery_status",
    usage_en: "/recovery_status",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/recovery_logs",
    args: "",
    description: { ru: "логи восстановления", en: "recovery logs" },
    usage_ru: "/recovery_logs",
    usage_en: "/recovery_logs",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/telega_start",
    args: "",
    description: { ru: "запуск Tele•Ga", en: "start Tele•Ga" },
    usage_ru: "/telega_start",
    usage_en: "/telega_start",
    roles: ["★", "★★", "★★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/telega_product_card",
    args: "<product_name>",
    description: { ru: "создать карточку товара", en: "create product card" },
    usage_ru: "/telega_product_card VPN Premium",
    usage_en: "/telega_product_card VPN Premium",
    roles: ["★", "★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/market_view",
    args: "",
    description: { ru: "просмотр маркетплейса", en: "view marketplace" },
    usage_ru: "/market_view",
    usage_en: "/market_view",
    roles: ["★", "★★", "★★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/market_create",
    args: "<title> <price>",
    description: { ru: "создать объявление", en: "create listing" },
    usage_ru: "/market_create My Product 999",
    usage_en: "/market_create My Product 999",
    roles: ["★", "★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/real_usage_loop",
    args: "",
    description: { ru: "прогнать реальный flow", en: "run real usage loop" },
    usage_ru: "/real_usage_loop",
    usage_en: "/real_usage_loop",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/real_market",
    args: "",
    description: { ru: "активировать рынок", en: "activate real market" },
    usage_ru: "/real_market",
    usage_en: "/real_market",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/market_stats",
    args: "",
    description: { ru: "статистика рынка", en: "market statistics" },
    usage_ru: "/market_stats",
    usage_en: "/market_stats",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/order_repeat",
    args: "<product_id>",
    description: { ru: "повторить заказ", en: "repeat order" },
    usage_ru: "/order_repeat prod_abc123",
    usage_en: "/order_repeat prod_abc123",
    roles: ["★", "★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/review",
    args: "<order_id> <rating> [comment]",
    description: { ru: "оставить отзыв", en: "submit review" },
    usage_ru: "/review order_abc123 5 Great!",
    usage_en: "/review order_abc123 5 Great!",
    roles: ["★", "★★", "★★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/referral_link",
    args: "",
    description: { ru: "получить реферальную ссылку", en: "get referral link" },
    usage_ru: "/referral_link",
    usage_en: "/referral_link",
    roles: ["★", "★★", "★★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/customer_stats",
    args: "[user_id]",
    description: { ru: "статистика клиентов", en: "customer statistics" },
    usage_ru: "/customer_stats",
    usage_en: "/customer_stats",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/system_load",
    args: "",
    description: { ru: "нагрузка системы", en: "system load" },
    usage_ru: "/system_load",
    usage_en: "/system_load",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/scale_report",
    args: "",
    description: { ru: "отчёт масштабирования", en: "scale report" },
    usage_ru: "/scale_report",
    usage_en: "/scale_report",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/seller_start",
    args: "",
    description: { ru: "стать продавцом", en: "become a seller" },
    usage_ru: "/seller_start",
    usage_en: "/seller_start",
    roles: ["★", "★★", "★★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/seller_profile",
    args: "",
    description: { ru: "профиль продавца", en: "seller profile" },
    usage_ru: "/seller_profile",
    usage_en: "/seller_profile",
    roles: ["★", "★★", "★★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    ...
    args: "",
    description: { ru: "дашборд продавца", en: "seller dashboard" },
    usage_ru: "/seller_dashboard",
    usage_en: "/seller_dashboard",
    roles: ["★", "★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    ...
    args: "<title> <price>",
    description: { ru: "добавить товар", en: "add product" },
    usage_ru: "/seller_add_product My Product 999",
    usage_en: "/seller_add_product My Product 999",
    roles: ["★", "★★"],
    category: "core",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/memory_save",
    args: "<text>",
    description: { ru: "сохранить в память", en: "save to memory" },
    usage_ru: "/memory_save important info",
    usage_en: "/memory_save important info",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/memory_find",
    args: "<query>",
    description: { ru: "найти в памяти", en: "find in memory" },
    usage_ru: "/memory_find canon",
    usage_en: "/memory_find canon",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/tektite_save",
    args: "<knowledge>",
    description: { ru: "сохранить знание", en: "save knowledge" },
    usage_ru: "/tektite_save this is a canon",
    usage_en: "/tektite_save this is a canon",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/oblivion_remember",
    args: "<experience>",
    description: { ru: "запомнить опыт", en: "remember experience" },
    usage_ru: "/oblivion_remember workflow failed",
    usage_en: "/oblivion_remember workflow failed",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/memory_status",
    args: "",
    description: { ru: "статус памяти", en: "memory status" },
    usage_ru: "/memory_status",
    usage_en: "/memory_status",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  ...
  },
  {
    ...
    args: "<price> <category>",
    description: { ru: "оптимизировать цену", en: "optimize pricing" },
    usage_ru: "/optimize_pricing 5000 service",
    usage_en: "/optimize_pricing 5000 service",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/optimize_ads",
    args: "",
    description: { ru: "оптимизировать рекламу", en: "optimize ads" },
    usage_ru: "/optimize_ads",
    usage_en: "/optimize_ads",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/insights",
    args: "",
    description: { ru: "рекомендации роста", en: "growth insights" },
    usage_ru: "/insights",
    usage_en: "/insights",
    roles: ["★"],
    category: "system",
  ...
  },
  {
    ...
    args: "",
    description: { ru: "чек-лист запуска", en: "launch checklist" },
    usage_ru: "/launch_checklist",
    usage_en: "/launch_checklist",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/launch_ready",
    args: "",
    description: { ru: "готовность к запуску", en: "launch readiness" },
    usage_ru: "/launch_ready",
    usage_en: "/launch_ready",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    ...
    args: "",
    description: { ru: "что блокирует запуск", en: "launch blockers" },
    usage_ru: "/launch_blockers",
    usage_en: "/launch_blockers",
    roles: ["★"],
    category: "system",
    ui: { showInHelp: true, showInCommands: true, showInButtons: false },
  },
  {
    name: "/full_test",
    args: "",
    description: { ru: "полный интеграционный тест", en: "full integration test" },
    usage_ru: "/full_test",
    usage_en: "/full_test",
    roles: ["★"],
    category: "system",
