...
import {
  handleEvidenceOperatorAction,
  canAccessEvidence,
} from "./forge-evidence-operator-surface.js";
import {
...
async function runOperatorSmokeTest(): Promise<{
  ok: boolean;
  passed: number;
  failed: number;
  results: SmokeResult[];
...
export async function runForgeOperatorSmoke(): Promise<void> {
