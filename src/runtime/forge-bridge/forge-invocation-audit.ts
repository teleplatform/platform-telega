...
export function buildForgeInvocationAuditLine(
...
export function buildForgeInvocationSummaryLine(
  record: ForgeInvocationEvidenceRecord,
): string {
...
export function getStatusEmoji(status: ForgeInvocationStatus): string {
  switch (status) {
    case "started":
      return "⏳";
    case "done":
...
export function formatEvidenceForExport(
  record: ForgeInvocationEvidenceRecord,
