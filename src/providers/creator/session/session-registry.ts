export type BridgeProviderId = "chatgpt_web" | "qwen_web" | "deepseek_web" | "grok_web" | "kimi_web" | "perplexity_web" | "claude_web" | "gemini_web" | "poe_web";
...
class InMemorySessionRegistry implements SessionRegistry {
  ...
  constructor() {
    const providers: SessionProviderId[] = ["chatgpt_web", "qwen_web", "deepseek_web", "grok_web", "kimi_web", "perplexity_web", "claude_web", "gemini_web", "poe_web"];
